 ...
 */
final class Version20230703070105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_list CHANGE confirmed_by confirmed_by INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_list CHANGE confirmed_by confirmed_by INT NOT NULL');
    }
}
